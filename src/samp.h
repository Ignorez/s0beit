...
struct stNewPatch
{
	bool FriendID[SAMP_MAX_PLAYERS];
	int FriendDogrulama[SAMP_MAX_PLAYERS];
	std::string FriendName[SAMP_MAX_PLAYERS];
	//Fake Client
	int iVersion = 4057;
	BYTE byteMod;
	BYTE byteNameLen;
...
extern int										g_iLastAttachedObjectIndex;
...
extern struct stNewPatch                        g_NewPatch;
